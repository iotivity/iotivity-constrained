...
arm-linux-androideabi-gcc -shared ./obj/*.o ../../port/android/arm-linux-androideabi-obj/*.o ../../port/android/arm-linux-androideabi-obj/client_server/*.o  -lm -lpthread -lrt -o libiotivity-lite-jni.so

#gcc -shared ./obj/*.o ../../port/android/x86_64-linux-android-obj/*.o ../../port/android/x86_64-linux-android-obj/client_server/*.o  -lm -lpthread -lrt -o libiotivity-lite-jni.so
